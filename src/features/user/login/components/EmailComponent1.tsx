    ...
    return (
        <>
            ...
            <div className="relative">
                <input type="text" id="email" name="email" placeholder="Email" value={emailValue} onChange={(e) => emailOnChange(e)} ref={inputRef} disabled={pending} className={`block mt-1 w-full border ${emailErrorMessages ? 'border-red-300': 'border-gray-300'} rounded-sm p-2
